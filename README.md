...
- `report.md` – Part 1 design write-up (file provided as `REPORT.md` in this repository).
- `part2_report.md` – Part 2 allocator performance analysis (provided as `PART2_REPORT.md`).
- `Makefile` – Defines build targets for the Part 1 and Part 2 binaries, including test helpers.
